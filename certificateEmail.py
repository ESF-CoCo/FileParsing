...
# Send email
with open('mailmergeCert.csv', 'r') as file:
...
It was an absolute pleasure to host such a vibrant community, and as we start thinking about the next ESF CoCo, we'd love your feedback to help us make it even better. Could you take just a few minutes to fill out our quick feedback form? Your thoughts are invaluable:
...
"""
	...
	certificate = os.getcwd() + '\\participants\\' + name + '.pdf'
